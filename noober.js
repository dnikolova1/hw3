...
passenger2DropoffAddressLine2 = `${ride[1].dropoffLocation.city}, ${ride[1].pickupLocation.state} ${ride[1].pickupLocation.zip}`
}
...
passenger3DropoffAddressLine2 = `${ride[2].dropoffLocation.city}, ${ride[2].pickupLocation.state} ${ride[2].pickupLocation.zip}`
}
